...
textureSurface = pygame.image.load('./Dilation/assets/original-image.png'), pygame.image.load('./Dilation/assets/dilation.png'), pygame.image.load('./Dilation/assets/result-image.png')
